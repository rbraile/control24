...
function twentyfourteen_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Servicios destacados Widget Area', 'twentyfourteen' ),
        'id'            => 'servicios-destacados',
        'description'   => __( 'Appears in the home site in the content area.', 'control24' ),
